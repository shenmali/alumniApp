...
import com.ty.AlumniApp.Utils.SectionsStatePagerAdapter;
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_item_bachelor:
                // Lisans bilgilerini göster
                return true;
            case R.id.menu_item_master:
                // Yüksek lisans bilgilerini göster
                return true;
            case R.id.menu_item_phd:
                // Doktora bilgilerini göster
                return true;
            default:
