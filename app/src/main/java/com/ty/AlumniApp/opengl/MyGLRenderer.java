package com.ty.AlumniApp.opengl;
...
//                    Log.d(TAG, "onDrawFrame: rendering SURFACE 1 image");
                    ...
                    if (imageRenderError && !isImage1Set) {
                        ...
                        widthScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface1ResourceIndex).getJSONObject(surface1MediaIndex).get(mContext.getString(R.string.width_scale_factor))));
                        heightScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface1ResourceIndex).getJSONObject(surface1MediaIndex).get(mContext.getString(R.string.height_scale_factor))));
                    }
...
//                    Log.d(TAG, "onDrawFrame: rendering surface 2 image");
                    ...
                    if (imageRenderError) {
                        ...
                        widthScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface2ResourceIndex).getJSONObject(surface2MediaIndex).get(mContext.getString(R.string.width_scale_factor))));
                        heightScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface2ResourceIndex).getJSONObject(surface2MediaIndex).get(mContext.getString(R.string.height_scale_factor))));
                    }
                    // Define the vertices for this face
                    float[] imageVertices = {
...
//                    Log.d(TAG, "onDrawFrame: rendering SURFACE 1 image");
                    ...
                    if (imageRenderError) {
                        ...
                        widthScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface3ResourceIndex).getJSONObject(surface3MediaIndex).get(mContext.getString(R.string.width_scale_factor))));
                        heightScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface3ResourceIndex).getJSONObject(surface3MediaIndex).get(mContext.getString(R.string.height_scale_factor))));
                    }
                    // Define the vertices for this face
                    float[] imageVertices = {
...
//                    Log.d(TAG, "onDrawFrame: rendering SURFACE 1 image");
                    ...
                    if (imageRenderError) {
                        ...
                        widthScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface4ResourceIndex).getJSONObject(surface4MediaIndex).get(mContext.getString(R.string.width_scale_factor))));
                        heightScaleFactor = Float.parseFloat(String.valueOf(mResources.get(surface4ResourceIndex).getJSONObject(surface4MediaIndex).get(mContext.getString(R.string.height_scale_factor))));
                    }
                    // Define the vertices for this face
                    float[] imageVertices = {
...
//        mPlayer = ExoPlayerFactory.newSimpleInstance(mContext, mTrackSelector);
        ...
        mSecondaryPlayer = new SimpleExoPlayer.Builder(mContext).build();
        mPlayer.setPlayWhenReady(false);
        mSecondaryPlayer.setPlayWhenReady(false);
    }
    ...
    private void initPlayer2(){
        ...
        mSecondaryPlayer2 = new SimpleExoPlayer.Builder(mContext).build();
        mPlayer2.setPlayWhenReady(false);
        mSecondaryPlayer2.setPlayWhenReady(false);
    }
    ...
    private void initPlayer3(){
        ...
        mSecondaryPlayer3 = new SimpleExoPlayer.Builder(mContext).build();
        mPlayer3.setPlayWhenReady(false);
        mSecondaryPlayer3.setPlayWhenReady(false);
    }
    ...
    private void initPlayer4(){
        ...
        mSecondaryPlayer4 = new SimpleExoPlayer.Builder(mContext).build();
        mPlayer4.setPlayWhenReady(false);
        mSecondaryPlayer4.setPlayWhenReady(false);
    }
